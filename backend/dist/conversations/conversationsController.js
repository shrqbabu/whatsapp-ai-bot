...
export class ConversationsController {
    ...
    static async takeover(req, res, next) {
        try {
            ...
            const updated = await ConversationsRepository.setTakeover(conversationId, true, duration);
            logEvent({ userId, conversationId, event: 'TAKEOVER_ENABLED' }, 'Manual takeover enabled on chat');
    ...
    static async resume(req, res, next) {
        try {
            ...
            const updated = await ConversationsRepository.setTakeover(conversationId, false, null);
            logEvent({ userId, conversationId, event: 'TAKEOVER_DISABLED' }, 'Manual takeover disabled, AI resumed on chat');
            wsEmitter.sendToUser(userId, 'takeover.changed', {
                conversationId,
    ...
    static async sendMessage(req, res, next) {
        try {
            ...
            const sentWaMessage = await WhatsAppSessionManager.sendMessage(userId, conversation.chat_jid, validated.text);
