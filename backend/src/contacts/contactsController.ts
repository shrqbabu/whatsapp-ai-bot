...
export class ContactsController {
  ...
  static async updateContactRules(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = req.user!.userId;
  ...
  static async getGroupRule(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = req.user!.userId;
  ...
  static async updateGroupRule(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = req.user!.userId;
      const groupJid = req.params.jid;
      const session = await SessionRepository.getOrCreateByUserId(userId);
